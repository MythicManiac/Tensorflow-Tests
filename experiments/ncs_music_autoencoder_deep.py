...
class ExperimentalModel(object):
    ...
    def build(self):
        ...
        # model.add(Activation("relu"))
        # model.add(MaxPool1D(2))
        # model.add(Conv1D(512, 3, padding="same", use_bias=False))
        # model.add(BatchNormalization())
        # model.add(Activation("relu"))
        # model.add(MaxPool1D(2))
        # model.add(Conv1D(32, 3, padding="same", use_bias=False))
        ...
        # model.add(Conv1D(256, 2, padding="same", use_bias=False))
        # model.add(BatchNormalization())
        # model.add(Activation("relu"))
        # model.add(UpSampling1D(2))
        # model.add(Conv1D(128, 2, padding="same", use_bias=False))
        # model.add(BatchNormalization())
        # model.add(Activation("relu"))
        # model.add(UpSampling1D(2))
        # model.add(Conv1D(128, 2, padding="same", use_bias=False))
        ...
        # model.add(Activation("relu"))
        # model.add(UpSampling1D(2))
        # model.add(Conv1D(64, 2, padding="same", use_bias=False))
        # model.add(BatchNormalization())
        # model.add(Activation("relu"))
        # model.add(UpSampling1D(2))
        # model.add(Conv1D(64, 2, padding="same", use_bias=False))
        ...
        # model.add(Activation("relu"))
        # model.add(UpSampling1D(2))
        # model.add(Conv1D(32, 2, padding="same", use_bias=False))
        # model.add(BatchNormalization())
        # model.add(Activation("relu"))
        # model.add(UpSampling1D(2))
        # model.add(Conv1D(1024, 2, padding="same", use_bias=False))
        # model.add(BatchNormalization())
        # model.add(Activation("relu"))
        # model.add(UpSampling1D(2))
        # model.add(Conv1D(512, 2, padding="same", use_bias=False))
        # model.add(BatchNormalization())
        # model.add(Activation("relu"))
        # model.add(UpSampling1D(2))
        model.add(Conv1D(256, 2, padding="same", use_bias=False))
        ...
        model.add(Activation("relu"))
        model.add(UpSampling1D(2))
        model.add(Conv1D(63, 2, padding="same", use_bias=False))
        model.add(BatchNormalization())
        model.add(Activation("relu"))
        model.add(UpSampling1D(2))
        model.add(Conv1D(32, 2, padding="same", use_bias=False))
        ...
        model.add(Activation("relu"))
        model.add(UpSampling1D(2))
        model.add(Conv1D(16, 2, padding="same", use_bias=False))
        model.add(BatchNormalization())
        model.add(Activation("relu"))
        model.add(UpSampling1D(2))
        model.add(Conv1D(1, 2, name="out", padding="same", use_bias=False))
        model.add(BatchNormalization())
        model.add(Activation("relu"))
        # model.add(decoder)
